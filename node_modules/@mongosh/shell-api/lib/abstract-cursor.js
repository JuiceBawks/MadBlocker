...
let AbstractCursor = class AbstractCursor extends decorators_1.ShellApiWithMongoClass {
    ...
    async [enums_1.asPrintable]() {
        var _a;
        return (await decorators_1.toShellResult((_a = this._currentIterationResult) !== null && _a !== void 0 ? _a : await this._it())).printable;
    }
    async _it() {
        const results = this._currentIterationResult = new result_1.CursorIterationResult();
        await helpers_1.iterate(results, this, await this._mongo._displayBatchSize());
    ...
    async explain(verbosity) {
        ...
        return helpers_1.markAsExplainOutput(explain);
    }
};
__decorate([
    decorators_1.returnType('this')
