...
class ShellEvaluator {
    ...
    async innerEval(originalEval, input, context, filename) {
        ...
        if (((_d = shellApi[cmd]) === null || _d === void 0 ? void 0 : _d.isDirectShellCommand) && !((_e = argv[0]) !== null && _e !== void 0 ? _e : '').startsWith('(')) {
        ...
        if (!hiddenCommands.test(input) && !hiddenCommands.test(rewrittenInput)) {
            this.instanceState.messageBus.emit('mongosh:evaluate-input', { input: history_1.redactSensitiveData(trimmedInput) });
        }
